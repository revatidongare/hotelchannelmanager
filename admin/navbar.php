...
<style>
	nav#sidebar {
    background: url(assets/img/sidebar1.png);
...
<nav id="sidebar" class='mx-lt-5' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=calendardelux" class="nav-item nav-categories"><span class='icon-field' style="padding-right: 4px;"><i class="fa fa-calendar"></i></span>Calendar Delux Room</a>

				<a href="index.php?page=calendarsingle" class="nav-item nav-categories"><span class='icon-field' style="padding-right: 4px;"><i class="fa fa-calendar"></i></span>Calendar Single Room</a>
